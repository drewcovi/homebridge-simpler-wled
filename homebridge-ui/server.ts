...
class PluginUiServer extends HomebridgePluginUiServer {
  ...
  constructor() {
    ...
    console.log('[UI Server] Calling ready() asynchronously...');
    process.nextTick(() => {
      this.ready();
...
console.log('[UI Server] Creating server instance at module level...');
const serverInstance = new PluginUiServer();
console.log('[UI Server] Server instance created');
